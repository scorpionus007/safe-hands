...
export default function RajeshPatelProfile() {
  const provider = {
    id: "rajesh-patel",
    firstName: "Rajesh",
    lastName: "Patel",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment: "Excellent treatment for my sports injury. Very professional and knowledgeable.",
      ...
      },
      {
        ...
        rating: 5,
        comment: "Great experience with post-surgery rehabilitation. Highly recommended!",
                ...
                <div className="md:col-span-2">
                  <div className="flex items-start space-x-6">
                    <Avatar className="w-24 h-24">
                      <AvatarImage 
                        src="/images/providers/rajesh-patel.jpg" 
                        alt="Rajesh Patel" 
                      />
                ...
                <div className="text-center md:text-right">
                  ...
                  <div className="space-y-3">
                    ...
                    <ShareModal 
                      ...
                      title={`Rajesh Patel - Senior Physiotherapist`}
                    />
                  </div>
                </div>
              </div>
